...
void RelBatchInsert::prepareCSRNodeGroup(PartitioningBuffer::NodeGroup& partition,
...
std::vector<offset_t> RelBatchInsert::populateStartCSROffsetsAndLengths(CSRHeaderChunks& csrHeader,
    offset_t numNodes, PartitioningBuffer::NodeGroup& partition, vector_idx_t offsetVectorIdx) {
