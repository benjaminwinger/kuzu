...
void StringNodeColumn::scanUnfiltered(transaction::Transaction* transaction,
    ...
    for (auto i = 0u; i < numValuesToRead; i++) {
        ...
        scanValueToVector(
            transaction, nodeGroupIdx, offsets[0], offsets[1], resultVector, startPosInVector + i);
    }
}

void StringNodeColumn::scanFiltered(transaction::Transaction* transaction,
