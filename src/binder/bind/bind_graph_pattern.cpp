...
static std::unique_ptr<LogicalType> getRecursiveRelLogicalType(
    ...
    auto nodesType = std::make_unique<LogicalType>(LogicalType::VAR_LIST(nodeType.copy()));
    auto relsType = std::make_unique<LogicalType>(LogicalType::VAR_LIST(relType.copy()));
