...
void Connection::addScalarFunction(std::string_view name, function::function_set definitions) {
    database->catalog->addFunction(std::string(name), std::move(definitions));
}
